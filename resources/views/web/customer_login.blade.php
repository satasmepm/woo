                            ...
                            <div class="padding_eight_all bg-white">
                                ...
                                <form method="post" action="{{ url('web/customer/login/check/verify') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" required name="cus_username" maxlength="15" placeholder="Username" />
                                    </div>
                                    <div class="form-group">
                                        <input required type="password" maxlength="15"  name="cus_password" placeholder="Your password" />
                                    </div>
