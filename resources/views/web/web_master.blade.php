...
<body>
       ...
       {{-- check customer logged session for every page --}}
                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li><a href="{{ url("web/customer/login/check") }}"><i class="fi fi-rs-user mr-10"></i>Login</a></li>
                                            ...
                                            <li><a href="{{ url("web/customer/signout") }}"><i class="fi fi-rs-sign-out mr-10"></i>Sign out</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
